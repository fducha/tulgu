#include "ownereditdialog.h"
#include "ui_ownereditdialog.h"
#include "../common/messages.h"

OwnerEditDialog::OwnerEditDialog(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::OwnerEditDialog)
{
    ui->setupUi(this);
...
OwnerEditDialog::~OwnerEditDialog()
{
    delete ui;
}

Owner OwnerEditDialog::start(const Owner &person) {
    if (person.isValid()) {
    ...
    if (code == QDialog::Accepted) {
        auto p = Owner(ui->leFamilyName->text(), ui->leName->text(),
